...
public class DescontoTest {
	...
	public void deveConcederDescontoDe30PorcentoParaIngressosDeClientesDeBancos() {
		...
		Filme filme = new Filme("Narcos", Duration.ofMinutes(50), "Trafico", new BigDecimal("12"));
	...
	public void deveConcederDescontoDe50PorcentoParaIngressosDeEstudante() {
		Lugar lugar = new Lugar("A", 1);
		Sala sala = new Sala("Eldorado - IMAX", new BigDecimal("20.5"));
		Filme filme = new Filme("Malevola", Duration.ofMinutes(60), "Infantil", new BigDecimal("12"));
